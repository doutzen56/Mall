...
namespace Mall.Model.EFModel
{
	...
	{
		private readonly IOptionsMonitor<SqlConnOptions>  _optionsMonitor;
		private readonly string _connStr;

		public MallContext(IOptionsMonitor<SqlConnOptions> optionsMonitor)
		{
		...
		public MallContext(string connstr)
		{
			_connStr = connstr;
		}
