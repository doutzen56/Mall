...
namespace Mall.Core.Redis
{
    ...
    public class RedisProvider : IDisposable
    {
        ...
        {
            return this.TryCatch<KeyValuePair<string, string>>(() =>
            {
